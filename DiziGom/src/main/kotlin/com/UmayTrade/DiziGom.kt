...
class DiziGom : MainAPI() {
    override var mainUrl = "https://www.alliance4creativity.com"
    ...
    override val mainPage = mainPageOf(
        "${mainUrl}/netflix-dizileri-hd1/" to "Netflix Dizileri",
        ...
        "${mainUrl}/cin-dizileri-hd1/" to "cin-dizileri-hd1",
        "${mainUrl}/anime-dizileri-hd1/" to "Anime Diziler",
        "${mainUrl}/apple-tv-dizileri-hd1/" to "Apple Tv+ Dizileri",
